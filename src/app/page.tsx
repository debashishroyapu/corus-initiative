...
import CookieConsent from "./components/CookieConsentSection";
...
export default function HomePage() {
  ...
  return (
    <div className="relative w-full overflow-x-hidden bg-gradient-to-b from-gray-900 via-gray-800 to-gray-100">

      {/* Multi-layer Parallax Background */}
      <motion.div
        style={{ y: yBackground }}
        className="absolute top-0 left-0 w-full h-[1600px] bg-gradient-to-b from-gray-900 via-gray-800 to-gray-100 -z-30"
      />
      <motion.div
        style={{ y: yForeground }}
        className="absolute top-0 left-0 w-full h-[800px] bg-[url('/Hero/ParallaxLayer.png')] bg-cover bg-center -z-20"
      />
      <motion.div
        style={{ y: yHeroText }}
        className="absolute top-0 left-0 w-full h-[600px] flex items-center justify-center -z-10"
      >
